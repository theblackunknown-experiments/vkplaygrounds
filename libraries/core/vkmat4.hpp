...
namespace blk
{
    struct mat4
    {
        ...
        {
                 if constexpr(i ==  0) { return m00; }
            else if constexpr(i ==  1) { return m01; }
            else if constexpr(i ==  2) { return m02; }
            else if constexpr(i ==  3) { return m03; }
            else if constexpr(i ==  4) { return m10; }
            else if constexpr(i ==  5) { return m11; }
            else if constexpr(i ==  6) { return m12; }
            else if constexpr(i ==  7) { return m13; }
            else if constexpr(i ==  8) { return m20; }
            else if constexpr(i ==  9) { return m21; }
            else if constexpr(i == 10) { return m22; }
            else if constexpr(i == 11) { return m23; }
            else if constexpr(i == 12) { return m30; }
            else if constexpr(i == 13) { return m31; }
            else if constexpr(i == 14) { return m32; }
            else if constexpr(i == 15) { return m33; }
            else
            {
